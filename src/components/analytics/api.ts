import { 
  ...
  export const fetchProjectSummary = async (projectId: number): Promise<Project> => {
    // In a real implementation, this would be:
    // return fetch(`${API_BASE_URL}/projects/${projectId}/summary/`).then(res => res.json());
  ...
  export const fetchProjectStats = async (projectId: number): Promise<ProjectStats> => {
    // Mock data
    return {
      total_images: 4250,
  ...
  export const fetchImageStats = async (projectId: number): Promise<ImageStats> => {
    // Mock data
    return {
      total: 4250,
      status_breakdown: {
  ...
  export const fetchAnnotationStats = async (projectId: number): Promise<AnnotationStats> => {
    // Mock data
    return {
      total: 15680,
      class_distribution: [
  ...
  export const fetchVersions = async (projectId: number): Promise<Version[]> => {
    // Mock data
    return [
      {
        id: 5,
  ...
  export const fetchAugmentationStats = async (projectId: number): Promise<AugmentationStats> => {
    // Mock data
    return {
      total: 8500,
      types: [
  ...
  export const fetchAnnotationGroups = async (projectId: number): Promise<AnnotationGroup[]> => {
    // Mock data
    return [
      {
        id: 1,
